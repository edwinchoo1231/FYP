...
public class MainActivity extends AppCompatActivity {
    ...
    public void onTrackerActivity(android.view.View view) {
        Intent intent = new Intent(this, TrackerActivity.class);
        intent.putExtra("EXTRA_DISPLAY_NAME",personName);
        startActivity(intent);
    }

    public void onBookingActivity(android.view.View view) {
        Intent intent = new Intent(this, BookingActivity.class);
        startActivity(intent);
    }
/*
    public void onSignInActivity(android.view.View view) {
